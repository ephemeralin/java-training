...
//    public void moveRight(boolean isEnd) throws ImpossibleMoveException, OccupiedWayException {
//        char column = board.getNextColumnLetter(this.position.getColumn());
//        int row = this.position.getRow();
//
//        Cell cell = board.findCell(row, column);
//        if (cell.isOccupied()) { //todo add logics for the occupation check
//            throw new OccupiedWayException(String.format("Choosen path is occupied on the cell %1", cell.getStringPosition()));
//        } else {
//            setPosition(cell);
//        }
//    }
//
//    public void moveLeft(boolean isEnd) throws ImpossibleMoveException, OccupiedWayException {
//        char column = board.getPreviousColumnLetter(this.position.getColumn());
//        int row = this.position.getRow();
//
//        Cell cell = board.findCell(row, column);
//        if (cell.isOccupied()) {
...
//    }
//
//    public void moveUp(boolean isEnd) throws ImpossibleMoveException, OccupiedWayException {
//        char column = this.position.getColumn();
//        int row = board.getNextRowNumber(this.position.getRow());
//
//        Cell cell = board.findCell(row, column);
//        if (cell.isOccupied()) {
//            throw new OccupiedWayException(String.format("Choosen path is occupied on the cell %1", cell.getStringPosition()));
...
//    }
//
//    public void moveDown(boolean isEnd) throws ImpossibleMoveException, OccupiedWayException {
//        char column = this.position.getColumn();
//        int row = board.getPreviousRowNumber(this.position.getRow());
//
//        Cell cell = board.findCell(row, column);
//        if (cell.isOccupied()) {
//            throw new OccupiedWayException(String.format("Choosen path is occupied on the cell %1", cell.getStringPosition()));
