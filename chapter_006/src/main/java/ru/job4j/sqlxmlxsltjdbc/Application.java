...
import ru.job4j.sqlxmlxsltjdbc.util.Util;
...
public class Application {
    ...
    public static void main(String[] args) throws JAXBException, IOException, SQLException, TransformerException, XMLStreamException {
        ...
        dataProcessor.putDataInXmlFile(data, Util.PATH + "1.xml");

        dataProcessor.convertXmlFile(Util.PATH + "xml_convert.xsl",
                                        Util.PATH +  "1.xml", Util.PATH + "2.xml");

        data = dataProcessor.getDataFromXmlFile(Util.PATH + "2.xml");
