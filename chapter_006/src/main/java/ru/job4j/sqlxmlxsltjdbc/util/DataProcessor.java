...
public class DataProcessor {
     ...
     */
    public void putDataIntoDb(String dbName, Data data) throws SQLException {

        Util util = new Util();

        Connection conn = util.getConnection(dbName);

        if (Util.prepareTable(conn)) {
    ...
    public Data getDataFromSql(String dbName) {
        Connection conn = new Util().getConnection(dbName);
        Data data = new Data();
